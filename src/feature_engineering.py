...
class FeatureEngineer:
    def __init__(self):
        ...
        self.encoder_path = ENCODER_SAVE_PATH
        self.df = None
        self.label_mapping={}
    ...
    def feature_construction(self):
        try:
            ...
            total_payback = self.df['LoanAmount'] * (1 + (self.df['InterestRate'] / 100))
            self.df['Monthly_Payment'] = total_payback / self.df['LoanTerm']
...
# -----
    ...
    def label_encoding(self):
        try:
            columns_to_encode = [
                'Age_Group', 'Education', 'EmploymentType',
            ...
            encoders = {}   # store encoders per column
            label_mappings = {}
            ...
            logger.info(f"Encoders saved at {self.encoder_path}")
    ...
    def feature_selection(self):
        try:
            ...
            self.df = self.df[top_features + ['Default']]
